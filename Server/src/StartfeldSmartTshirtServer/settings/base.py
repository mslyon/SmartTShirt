"""
Django settings for StartfeldSmartTshirtServer project.
...
ROOT_URLCONF = 'StartfeldSmartTshirtServer.urls'

WSGI_APPLICATION = 'StartfeldSmartTshirtServer.wsgi.application'
